...
## from the web and saves to csv with date as prefix
scrape_AnnouncementsPrev <- function() {
    
    library(stringr)     
    fileURL = "https://www.asx.com.au/asx/statistics/prevBusDayAnns.do"
    ...
    filecsv <- paste(COB,"_announcements.csv",sep="")
